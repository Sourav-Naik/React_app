...
export default function Footer(props) {
  return (
    <div
      ...
      } text-white text-start p-0 mt-1`}
    >
      <div className="row pt-4 px-4 m-0">
        ...
        <div className="col-4 p-2">
          ...
          <i className="fa-brands fa-facebook pe-2"/><i className="fa-brands fa-x-twitter pe-2"/>
          <i className="fa-brands fa-youtube pe-2"/>
          </div>
        </div>
      </div>
      <div className="text-center fs-6 border-top p-3"><i className="fa-regular fa-heart"></i> This react project was created by <span className="fw-semibold">Sourav Naik <i className="fa-regular fa-heart"></i></span></div>
    </div>
  );
}
